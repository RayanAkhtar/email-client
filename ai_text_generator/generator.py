...
def generate_text_chained(prompts):
    ...
    for prompt in prompts:
        ...
        prompt_number += 1
        while True:
            message = f"Currently processing prompt number {prompt_number - 1}...\n"
            try:
                ...
                io.clear_screen()
                print(message + "Currently waiting on rate limit to reset, may take up to 60 secs")
