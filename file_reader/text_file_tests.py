...
class MyTestCase(unittest.TestCase):
    ...
    def test_read_txt_single_line(self):
        # Checks to see if a single lined txt file is read correctly
    ...
    def test_read_txt_multiple_lines(self):
        # Checks to see if a multiple lined txt file is read correctly
...
I am doing a project in [project]"""
    ...
    def test_read_txt_multiple_lines_with_space(self):
        # Checks to see if a multi-lined txt file is read correctly and preserves whitespace
...
I am currently doing a project in [project]."""
    ...
    def test_read_txt_large(self):
        # Checks to see if a large multi-lined txt file is read correctly
